...
def main(data_yaml: str, model: str = "yolov8n.pt", epochs: int = 50, imgsz: int = 240) -> None:
    try:
    ...
    yolo = YOLO(model)
    yolo.train(data=data_yaml, epochs=epochs, imgsz=imgsz, project="outputs/yolo", name="tumor_detector")
...
if __name__ == "__main__":
    ...
    main(args.data_yaml, args.model, args.epochs, args.imgsz)
